...
export interface SourceBot {
  ...
  script?: string;
  /** FastAPI bot ID — when present, the RUN button calls the real backend. */
  botId?: string;
}
...
const oemConfig: SolutionDef = {
  ...
  sources: [
    { name: "BMW Configurator",   url: "bmwusa.com/build",        region: "NA",     script: "BMW_Data_Collector.py",      botId: "bmw-configurator"   },
    { name: "Tesla Configurator", url: "tesla.com/models/design", region: "Global", script: "tesla_data_extractor.py", botId: "tesla-configurator" },
